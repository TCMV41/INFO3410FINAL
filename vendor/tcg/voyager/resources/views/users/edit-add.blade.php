                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <select name="approved" id="approved" class="form-control" value="@if(isset($dataTypeContent->approved)){{ old('approved', $dataTypeContent->approved) }}@else{{old('approved')}}@endif">
